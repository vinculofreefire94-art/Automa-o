...
class Config:
    ...
    PRIMARY_TF: str = "4h"   # Timeframe principal para sinais
    ...
    # ── Risk Management ──────────────────────────────────────────────────────
    TP_MULTIPLIER: float = 2.0    # TP = entrada ± ATR * TP_MULTIPLIER
    SL_MULTIPLIER: float = 1.0    # SL = entrada ∓ ATR * SL_MULTIPLIER
